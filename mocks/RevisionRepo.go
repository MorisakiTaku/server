...
// CountCharacterRelated provides a mock function with given fields: ctx, id
func (_m *RevisionRepo) CountCharacterRelated(ctx context.Context, id uint32) (int64, error) {
...
//  - ctx context.Context
//  - id uint32
func (_e *RevisionRepo_Expecter) CountCharacterRelated(ctx interface{}, id interface{}) *RevisionRepo_CountCharacterRelated_Call {
	return &RevisionRepo_CountCharacterRelated_Call{Call: _e.mock.On("CountCharacterRelated", ctx, id)}
}

func (_c *RevisionRepo_CountCharacterRelated_Call) Run(run func(ctx context.Context, id uint32)) *RevisionRepo_CountCharacterRelated_Call {
...
// ListCharacterRelated provides a mock function with given fields: ctx, id, limit, offset
func (_m *RevisionRepo) ListCharacterRelated(ctx context.Context, id uint32, limit int, offset int) ([]model.Revision, error) {
...
//  - limit int
//  - offset int
func (_e *RevisionRepo_Expecter) ListCharacterRelated(ctx interface{}, id interface{}, limit interface{}, offset interface{}) *RevisionRepo_ListCharacterRelated_Call {
	return &RevisionRepo_ListCharacterRelated_Call{Call: _e.mock.On("ListCharacterRelated", ctx, id, limit, offset)}
}

func (_c *RevisionRepo_ListCharacterRelated_Call) Run(run func(ctx context.Context, id uint32, limit int, offset int)) *RevisionRepo_ListCharacterRelated_Call {
	_c.Call.Run(func(args mock.Arguments) {
